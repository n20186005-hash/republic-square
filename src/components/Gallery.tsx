...
const photos = [
  { src: '/gallery/images (1).jpg', alt: 'Republic Square Panorama' },
  { src: '/gallery/images (2).jpg', alt: 'Prince Mihailo Monument' },
  { src: '/gallery/images (3).jpg', alt: 'National Museum of Serbia' },
  { src: '/gallery/images (4).jpg', alt: 'National Theatre of Belgrade' },
  { src: '/gallery/images (5).jpg', alt: 'Square Architecture' },
  { src: '/gallery/images (6).jpg', alt: 'Historic Buildings' },
  { src: '/gallery/images (7).jpg', alt: 'Republic Square View' },
  { src: '/gallery/images (8).jpg', alt: 'Belgrade City Center' },
  { src: '/gallery/images (9).jpg', alt: 'Square Street Scene' },
  { src: '/gallery/images (10).jpg', alt: 'Monument Detail' },
  { src: '/gallery/images (11).jpg', alt: 'Evening Atmosphere' },
  { src: '/gallery/images (12).jpg', alt: 'Surrounding Architecture' },
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="flex justify-center mt-6 gap-4 items-center">
              <a
                href="https://maps.app.goo.gl/4seTVgQK6uszwLtJ6"
                target="_blank"
